...
public class Ejercicio5 {
	...
	public static void main(String[] args) {
		...
		System.out.print("Introduzca su tipo de carnet de conducir, use las opciones "
				+ "indicadas a continuacion, E: remolques. D: autobuses.  \n"
				+ "C1-C5: camiones. A: motocicletas. B1-B2: automóviles.");
